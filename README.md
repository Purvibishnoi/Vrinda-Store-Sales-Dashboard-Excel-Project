...
| File                               | Description                               |
| ---------------------------------- | ----------------------------------------- |
| Vrinda Store Data Analysis.xlsx    | Contains dataset, analysis, and dashboard |
...
This project is created for learning and demonstration purposes using sample data.
